...
class Contact extends Component{
    ...
    updatedElement.isValid=this.validationCheckHandler(updatedElement.value, updatedElement.validation);
    ...
    render(){
     let formArray=[];
       ...
       let form=<div className={classes.form}>
       {formArray.map(el=>(
           <InputComp 
           key={el.id}
       ...
       <button disabled={!this.state.formValidity} onClick={this.submitClickHandler} >Submit</button>
      </div>
        ...
        return(
            ...
            <div className={classes.contact}>
                ...
                <div>
                <h3>E-mail</h3>
                <h4><a href="mailto:khushimuskaan1999@gmail.com">khushimuskaan<br></br>1999@gmail.com</a></h4>
            ...
            <h5>E-mail</h5>
            <h5><a href="mailto:khushimuskaan1999@gmail.com">khushimuskaan<br></br>1999@gmail.com</a></h5>
