    ...
    return (
      <div className={classes.navitems}>
        <div className={classes.list}>
          ...
          <NavItem path="/who" trans="slide-down" delay="1500" duration="300" easing="ease-in-out">
            WHO
          </NavItem>
          <NavItem path="/work" trans="slide-down" delay="2000" duration="300" easing="ease-in-out">
            WORK
          </NavItem>
        </div>
      </div>
