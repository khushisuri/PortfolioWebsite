...
const ArtSheet=(props)=>{
   ...
   <section className="main-section">
     <h1>Art</h1>
     <p>The expression or application of human creative skill and imagination,
        producing works to be appreciated primarily for their beauty or <i>emotional</i> power</p>
